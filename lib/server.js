...
(function (Json) {
    ...
    function value(mix) {
        return function (target, propertyKey, descriptor) {
            var _a;
            var meta = JsonUtils_1.JsonUtils.resolveModelMeta(target);
            var defs = (_a = meta.defaults, (_a !== null && _a !== void 0 ? _a : (meta.defaults = {})));
...
(function (JsonValidate) {
    ...
    function validateByMeta(model, root, meta, path) {
        ...
        for (var key in model) {
            var val = model[key];
            var propInfo = meta.properties[key];
            var error = validateSingleValue(model, val, (root !== null && root !== void 0 ? root : model), key, propInfo, path);
            if (error) {
...
(function (JsonDeserializer) {
    ...
    function resolveValue(val, info, settings) {
        ...
        if ((_c = info) === null || _c === void 0 ? void 0 : _c.Type) {
        ...
        if (Types_1.Types.isArray(val)) {
            ...
            var arrayType = (_d = info) === null || _d === void 0 ? void 0 : _d.ArrayType;
            var converter = (_e = info) === null || _e === void 0 ? void 0 : _e.Converter;
            var itemInfo = {
                Type: arrayType,
                Converter: converter
            };
...
(function (JsonConvert) {
    ...
    function fromJSON(json, settings) {
        ...
        var meta = JsonUtils_1.JsonUtils.pickModelMeta(Type) || getMetaFor(Type);
...
var atma_utils_1 = require("atma-utils");
var HttpError_1 = _src_HttpError_HttpError;
var class_json_1 = _node_modules_class_json_lib_class_json;
var Types;
(function (Types) {
