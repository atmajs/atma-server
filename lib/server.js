    ...
    Static: {
        create: function (mix, statusCode) {
            ...
            if (mix instanceof Error) {
                let error = new exports.HttpError(mix.message, statusCode || 500);
                error._error = mix;
                return error;
            }
            if (dependency_1.is_Object(mix)) {
                ...
                let msg = mix.message, code = statusCode || mix.statusCode || mix.status, error;
...
exports.path_resolveSystemUrl = function (path, base = null) {
...
function Config(params, app, done, fail) {
    ...
    let configs = ConfigUtils_1.cfg_prepair(path_base, configPaths, PATH);
    if (configs) {
...
const path_1 = _src_util_path;
const dependency_1 = _src_dependency;
class WatcherHandler extends dependency_1.Class.EventEmitter {
    static get Instance() {
...
class FileWatcher extends dependency_1.Class.EventEmitter {
    constructor(file) {
        super();
        this.file = file;
        this.active = false;
...
exports.fn_delegate = function (fn, ...args) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const dependency_1 = _src_dependency;
class HttpPageBase extends dependency_1.Class.Deferred {
...
exports.send_JSON = function (req, res, json, statusCode, headers) {
    ...
    try {
        ...
        return exports.send_Error(req, res, new HttpError_1.RuntimeError('Json Serialization'));
    }
...
class HttpSubApplication extends dependency_1.Class.Deferred {
...
const dependency_2 = _src_dependency;
const http = require("http");
const https = require("https");
let _emitter = new dependency_1.Class.EventEmitter();
class Application extends dependency_1.Class.Deferred {
    constructor(proto = {}) {
        super();
        ...
        this.args = dependency_1.obj_extend(proto.args, cli_1.cli_arguments());
        this._baseConfig = proto;
        this._loadConfig();
        if (this.isRoot && app_1.app_isDebug() !== true) {
     ...
     */
    processor(data = {}) {
        let before = data.before, after = data.after, middleware = data.middleware;
    ...
    execute(url, method, body, headers) {
        let req = new Message_1.Request(url, method, body, headers), res = new Message_1.Response;
...
function handler_resolveHeaders(app, handler, overrides = null) {
    let headers_Handler = handler.meta && handler.meta.headers, headers_App = app.config.headers;
...
function resources_load(app, callback) {
    ...
    let config = app.config, base = config.base, env = config.env;
...
exports.default = {
    classParser: function (name, Ctor) {
        ...
        return function (req, res, params, next) {
            ...
            let error = dependency_1.Class.validate(model);
            if (error != null) {
...
;
				...
				(function () {
					...
					"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const static_1 = _src_HttpService_static;
const dependency_1 = _src_dependency;
const HttpError_1 = _src_HttpError_HttpError;
exports.default = {
...
Object.defineProperty(exports, "__esModule", { value: true });
const dependency_1 = _src_dependency;
exports.secure_canAccess = function (req, secure) {
    if (secure == null) {
        return true;
    }
...
const atma_utils_1 = require("atma-utils");
const IHttpHandler_1 = _src_IHttpHandler;
let HttpServiceProto = dependency_1.Class({
...
(function (RouteUtils) {
    ...
    function resolve(endpoint) {
        let routes = new dependency_1.ruta.Collection;
...
Application_1.default.on('configurate', function (app) {
    ...
    Autoreload_1.default.getWatcher().on('fileChange', (path, file) => {
...
const HttpPage_1 = _src_HttpPage_HttpPage;
const dependency_1 = _src_dependency;
class MaskRunner extends dependency_1.Class.Deferred {
    constructor(route, app) {
        super();
        this.route = route;
        this.app = app;
...
const CrudWrapper_1 = _src_HttpService_CrudWrapper;
