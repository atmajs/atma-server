...
var $anyClass = Class;
var $Class = (_b = (_a = $anyClass.default, (_a !== null && _a !== void 0 ? _a : $anyClass.Class)), (_b !== null && _b !== void 0 ? _b : $anyClass));
exports.Class = $Class;
...
function nextDelegate(runner, req, res, callback, config, index) {
    return function (error, result) {
        ...
        if ((_a = result) === null || _a === void 0 ? void 0 : _a.done) {
...
function send_Error(req, res, error, headers, app, startedAt) {
    ...
    (_a = app) === null || _a === void 0 ? void 0 : _a.lifecycle.completeHandlerError(startedAt, req, res, error);
    send_Content(req, res, JSON.stringify(error), error.statusCode || 500, mime_1.mime_JSON, headers, app, startedAt);
}
exports.send_Error = send_Error;
;
function send_Content(req, res, content, statusCode, mimeType, headers, app, startedAt) {
    var _a;
    ...
    if (res.statusCode < 300) {
        (_a = app) === null || _a === void 0 ? void 0 : _a.lifecycle.completeHandlerSuccess(startedAt, req, res);
    }
    res.end(content);
}
...
var ErrorHandler = /** @class */ (function (_super) {
    ...
    ErrorHandler.prototype.process = function () {
        var _a;
        return this.reject((_a = this.message, (_a !== null && _a !== void 0 ? _a : 'Invalid Routing')));
    };
    return ErrorHandler;
}(atma_utils_1.class_Dfr));
;
...
var WebSocket = /** @class */ (function () {
    ...
    WebSocket.prototype.emit = function (namespace) {
        ...
        if (this.io == null && this.ioSsl === null) {
            ...
            (_a = cb) === null || _a === void 0 ? void 0 : _a({ message: 'Server is not started' });
            return;
        }
        if (this.SocketListeners[namespace] == null) {
            console.error('No handlers are bound to the namespace', namespace);
            (_b = cb) === null || _b === void 0 ? void 0 : _b({ message: 'No handlers' });
            return;
        }
...
exports.default = {
    ...
    $getTemplate: function (pageData) {
        var _a, _b;
        var template = (_a = pageData.template, (_a !== null && _a !== void 0 ? _a : (_b = this.page.index) === null || _b === void 0 ? void 0 : _b.template));
        if (template == null) {
            return null;
        }
...
(function (HttpEndpointExplorer) {
    function getMeta(Type) {
        ...
        var meta = (_a = Type.prototype.meta, (_a !== null && _a !== void 0 ? _a : {}));
        var output = {
            path: meta.path,
            description: (_b = meta.description, (_b !== null && _b !== void 0 ? _b : (_c = jsonMeta) === null || _c === void 0 ? void 0 : _c.description)),
            paths: []
        };
        ...
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
            ...
            var apiParams = (_e = (_d = methodParamsMeta) === null || _d === void 0 ? void 0 : _d.map(function (methodParamMeta) {
                var _a, _b;
                return {
                    in: methodParamMeta.from === 'uri' ? 'query' : 'body',
                    name: methodParamMeta.name,
                    description: (_a = methodParamMeta.description, (_a !== null && _a !== void 0 ? _a : (_b = methodParamMeta.Type) === null || _b === void 0 ? void 0 : _b.name)),
                    schema: getSchema(methodParamMeta.Type),
                    required: methodParamMeta.optional === true ? false : true
                };
            }), (_e !== null && _e !== void 0 ? _e : []));
            var apiResponses = (_g = (_f = methodMeta.responses) === null || _f === void 0 ? void 0 : _f.map(function (resp) {
                var _a, _b;
                return {
                    statusCode: resp.status,
                    description: (_a = resp.description, (_a !== null && _a !== void 0 ? _a : (_b = resp.Type) === null || _b === void 0 ? void 0 : _b.name)),
            ...
            var apiRoute = {
                ...
                method: route[1],
                operationId: key,
                description: (_h = methodMeta.description, (_h !== null && _h !== void 0 ? _h : (_l = (_k = (_j = jsonMeta) === null || _j === void 0 ? void 0 : _j.properties) === null || _k === void 0 ? void 0 : _k[key]) === null || _l === void 0 ? void 0 : _l.description)),
...
var LifecycleEvents = /** @class */ (function (_super) {
    ...
    LifecycleEvents.prototype.completeHandlerSuccess = function (start, req, res) {
        ...
        EVENT.define('HandlerSuccess', time, req.url + " completed in " + time + "ms", req.url, res.statusCode);
        this.emitEvent(EVENT, req, res);
    };
    LifecycleEvents.prototype.completeHandlerError = function (start, req, res, error) {
        var time = Date.now() - start;
        var message = req.url + " completed in " + time + "ms with error: " + error;
        EVENT.define('HandlerError', time, message, req.url, res.statusCode, error);
        this.emitEvent(EVENT, req, res);
    };
    LifecycleEvents.prototype.emitError = function (error, req) {
        var _a;
        var message = "" + error;
        EVENT.define('Error', 0, message, (_a = req) === null || _a === void 0 ? void 0 : _a.url, 0, error);
        this.emitEvent(EVENT);
    };
...
var LifecycleEvent = /** @class */ (function () {
    ...
    LifecycleEvent.prototype.define = function (type, time, message, url, status, error, user) {
        this.time = time;
        this.type = type;
...
function handler_complete(app, handler, req, res, content, statusCode, mimeType, headers, startedAt) {
    var _a;
    var send = (_a = handler.send, (_a !== null && _a !== void 0 ? _a : send_1.send_Content));
...
function cfg_doneDelegate(app) {
    return function () {
        ...
        Promise.all([
            HttpEndpointExplorer_1.HttpEndpointExplorer.find(app.config.service.endpoints),
            resources_load(app)
        ]).then(function (_a) {
            var endpoints = _a[0];
            if (endpoints) {
...
var HttpServiceProto = dependency_1.Class({
    ...
    process: function (req, res) {
        ...
        if (args != null) {
            ...
            if (error) {
                return this.reject(new HttpError_1.RequestError((_a = error.message, (_a !== null && _a !== void 0 ? _a : error.toString()))));
            }
        }
        var result = endpoint
            .process
...
(function (TypeConverter) {
    function fromType(json, Type) {
        ...
        var instance = (_c = (_b = (_a = Type).fromJSON) === null || _b === void 0 ? void 0 : _b.call(_a, json), (_c !== null && _c !== void 0 ? _c : class_json_1.JsonConvert.fromJSON(json, { Type: Type })));
        var error = Type.validate != null
            ? Type.validate(instance)
            : class_json_1.JsonValidate.validate(instance);
