...
var LifecycleEvents = /** @class */ (function (_super) {
    ...
    LifecycleEvents.prototype.completeHandlerSuccess = function (start, req, res) {
        ...
        EVENT.define('HandlerSuccess', time, req.url + " completed in " + time + "ms", req.method, req.url, res.statusCode);
    ...
    LifecycleEvents.prototype.completeHandlerError = function (start, req, res, error) {
        ...
        EVENT.define('HandlerError', time, message, req.method, req.url, res.statusCode, error);
        this.emitEvent(EVENT, req, res);
    };
    LifecycleEvents.prototype.emitError = function (error, req) {
        var message = "" + error;
        EVENT.define('Error', 0, message, req === null || req === void 0 ? void 0 : req.method, req === null || req === void 0 ? void 0 : req.url, 0, error);
        this.emitEvent(EVENT);
    };
...
var LifecycleEvent = /** @class */ (function () {
    ...
    LifecycleEvent.prototype.define = function (type, time, message, method, url, status, error, user) {
        this.time = time;
        this.type = type;
