...
var HandlerFactory = /** @class */ (function () {
    ...
    HandlerFactory.prototype.registerEndpoints = function (endpoints) {
        var _this = this;
        endpoints === null || endpoints === void 0 ? void 0 : endpoints.forEach(function (Ctor) { return _this.registerEndpoint(Ctor); });
    };
                            ...
                            return __awaiter(this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            pckg = _a.sent();
                                            pckgbase = '/' + dirName + '/' + name + '/', main = pckg === null || pckg === void 0 ? void 0 : pckg.main;
                                            if (main == null) {
                                                main = 'index.js';
                                            }
...
var Application = /** @class */ (function (_super) {
    ...
    function Application(proto) {
        ...
        if (proto.endpoints) {
            _this.handlers.registerEndpoints(proto.endpoints);
        }
