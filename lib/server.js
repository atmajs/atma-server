...
var Response = /** @class */ (function (_super) {
    ...
    return Response;
}(atma_utils_1.mixin(atma_utils_1.class_EventEmitter, atma_utils_1.class_Dfr)));
...
var HttpContext = /** @class */ (function () {
    ...
    HttpContext.prototype.redirect = function (url, code) {
        if (code === void 0) { code = 302; }
        send_1.send_REDIRECT(this.res, url, code);
        this._redirect = url;
    };
...
exports.page_processRequest = function (page, req, res, config) {
    if (page.pattern) {
        var query = ruta_1.parse(page.pattern, req.url).params;
...
(function () {
    ...
    memory_resolve = function (factory, url, route, callback) {
        var match = rgx.exec(url), str = match[0], type = match[1], path = url.substring(match.index + match[0].length), memory = getContext(type), Handler = atma_utils_1.obj_getProperty(memory, path);
        if (Handler == null) {
            dependency_1.logger.error('<handler> invalid route', url);
            callback(new ErrorHandler('Invalid route: ' + url));
            return;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!atma_utils_1.is_Array(path)) return [3 /*break*/, 2];
...
var Application = /** @class */ (function (_super) {
    ...
    Application.prototype._loadConfig = function () {
        ...
        Config_1.default(definition, this).then(cfg_doneDelegate(this), function (error) {
            dependency_1.logger
...
function cfg_doneDelegate(app) {
    return function (cfg) {
        app.config = cfg;
        if (app.isRoot && app_1.app_isDebug() !== true) {
...
;
	...
	if (isObject(_src_env_overrides) && isObject(module.exports)) {
