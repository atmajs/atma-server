...
var LifecycleEvents = /** @class */ (function (_super) {
    ...
    LifecycleEvents.prototype.completeHandlerSuccess = function (start, req, res) {
        ...
        EVENT.define('HandlerSuccess', time, req.url + " completed in " + time + "ms", req.method, req.url, res.statusCode, null, '', req.headers['x-forwarded-for'] || req.connection.remoteAddress);
    ...
    LifecycleEvents.prototype.completeHandlerError = function (start, req, res, error) {
        ...
        EVENT.define('HandlerError', time, message, req.method, req.url, res.statusCode, error, '', req.headers['x-forwarded-for'] || req.connection.remoteAddress);
        this.emitEvent(EVENT, req, res);
    };
