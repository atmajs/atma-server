...
declare module 'atma-server' {
    import { createStaticMid } from 'atma-server/middleware/static'; 
     import { StaticMid } from 'atma-server/middleware/static'; 
     import { BodyJsonMid } from 'atma-server/middleware/bodyJson'; 
     import { QueryMid } from 'atma-server/middleware/query'; 
    ...
    export { HttpError, NotFoundError, RequestError, RuntimeError, SecurityError, Application, HttpSubApplication, HttpErrorPage, HttpPage, HandlerFactory, HttpService, IHttpHandler, HttpResponse, HttpEndpoint, Middleware, LifecycleEvents };
    export const middleware: {
            query: typeof QueryMid;
            bodyJson: typeof BodyJsonMid;
            static: typeof StaticMid;
            files: typeof createStaticMid;
    };
...
declare module 'atma-server/middleware/static' {
    ...
    export function StaticMid(config: IStaticServerConfig): any;
    export function createStaticMid(config: IStaticServerConfig): any;
}

declare module 'atma-server/middleware/bodyJson' {
    import { ServerResponse, IncomingMessage } from 'http';
    type TBodyConfig = {
        limit: number | string;
    };
    export function BodyJsonMid(config?: TBodyConfig): (req: IncomingMessage & {
        body?: any;
    }, res: ServerResponse, next: any) => void;
    export {};
}

declare module 'atma-server/middleware/query' {
    export function QueryMid(req: any, res: any, next: any): void;
}
...
declare module 'atma-server/IHttpHandler' {
    ...
    export class HttpResponse {
        ...
        static ensure(result: string | Buffer | ReadableStream | HttpResponse | Error | any, statusCode?: number): HttpResponse;
        static pipe(dfr: class_Dfr, result: HttpResponse['content'] | HttpResponse): void;
    }
}
...
declare module 'atma-server/HttpService/HttpService' {
    import { THttpServiceDefinition } from 'atma-server/HttpService/types';
...
declare module 'atma-server/middleware/export' {
    import { BodyJsonMid } from 'atma-server/middleware/bodyJson';
    import { QueryMid } from 'atma-server/middleware/query';
    import { StaticMid, createStaticMid } from 'atma-server/middleware/static';
    const _default: {
        query: typeof QueryMid;
        bodyJson: typeof BodyJsonMid;
        static: typeof StaticMid;
...
declare module 'atma-server/Config/Config' {
    ...
    import { IApplicationConfig } from 'atma-server/HttpApplication/IApplicationConfig';
    import type Application from 'atma-server/HttpApplication/Application';
    export default function Config(params: IApplicationConfig, app?: Application): Promise<AppConfig<any> & {
        [key: string]: any;
    }>;
}
...
declare module 'atma-server/HttpService/types' {
    import { HttpError } from 'atma-server/HttpError/HttpError';
    import { IHttpHandler } from 'atma-server/IHttpHandler';
    type THttpProcessFn = (this: IHttpHandler, req: any, res: any, params: any, next: any) => void | HttpError | Promise<void | HttpError>;
