...
declare module 'atma-server/HttpService/HttpEndpoint' {
    import { default } from 'ruta/route/RouteCollection'; 
    ...
    export namespace RouteUtils {
            function resolveFromType(endpoint: HttpEndpoint): default;
            function resolveFromProto(prototype: any): default;
    }
}
